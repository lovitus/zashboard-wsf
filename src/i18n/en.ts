const en = {
  ...
  tunnelForwarding: 'Port Forwarding Tunnel',
  tunnelTool: 'Forwarding Tool',
  tunnelArgs: 'Command Arguments',
  tunnelLocalPort: 'Local Port',
  tunnelAutoStart: 'Auto-start on launch',
  ...
  tunnelAvBlockedDesc:
    'Windows Defender flagged the tunnel tool as a false positive. Click below to add an exclusion (requires admin privileges).',
  tunnelAvFix: 'Add Defender Exclusion',
  tunnelAvFixed: 'Exclusion added for',
  tunnelHealthRestored: 'Tunnels restored',
  ...
  updaterUpToDate: 'You are on the latest version',
  updaterOpenRelease: 'Open Release',
  updaterShowHistory: 'Show all versions',
  updaterHideHistory: 'Hide versions',
  updaterCurrent: 'current',
  updaterCustomUrl: 'Custom update URL',
  updaterCustomUrlPlaceholder: 'https://api.github.com/repos/user/repo/releases',
  updaterCustomUrlSaved: 'Custom URL saved',
  updaterCustomUrlCleared: 'Custom URL cleared (using default)',
  updaterCheckFailed: 'Update check failed',
  updaterDownloadFailed: 'Download failed',
  upstreamTitle: 'Upstream Zashboard UI',
  upstreamBuiltin: 'Built-in',
  upstreamActive: 'Active',
  upstreamActiveDesc: 'Using upstream version {version}',
  upstreamSwitchBuiltin: 'Switch to Built-in',
  upstreamCheckVersions: 'Check Upstream Versions',
  ...
  upstreamDownloadBase: 'Download base URL',
  upstreamClearCustom: 'Reset to default',
}
