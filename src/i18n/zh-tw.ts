...
const zhTW: LANG_MESSAGE = {
  ...
  tunnelForwarding: '端口轉發隧道',
  tunnelTool: '轉發工具',
  tunnelArgs: '命令參數',
  tunnelLocalPort: '本地端口',
  tunnelAutoStart: '啟動時自動連接',
  tunnelStart: '啟動隧道',
  tunnelStop: '停止隧道',
  tunnelRunning: '運行中',
  tunnelStopped: '已停止',
  ...
  tunnelAvBlockedDesc:
    'Windows Defender 誤報了隧道工具。點擊下方新增排除項（需要管理員權限，會彈出 UAC 提示）。',
  tunnelAvFix: '新增 Defender 排除項',
  tunnelAvFixed: '已新增排除項',
  tunnelHealthRestored: '隧道已恢復',
  updaterTitle: '應用更新',
  updaterCurrentVersion: '當前版本',
  updaterCheck: '檢查更新',
  updaterAvailable: '有新版本可用',
  updaterUpToDate: '已是最新版本',
  updaterOpenRelease: '打開發佈頁',
  updaterShowHistory: '顯示所有版本',
  updaterHideHistory: '隱藏版本列表',
  updaterCurrent: '當前',
  updaterCustomUrl: '自訂更新地址',
  updaterCustomUrlPlaceholder: 'https://api.github.com/repos/user/repo/releases',
  updaterCustomUrlSaved: '自訂地址已儲存',
  updaterCustomUrlCleared: '已恢復預設更新地址',
  updaterCheckFailed: '檢查更新失敗',
  updaterDownloadFailed: '下載失敗',
  upstreamTitle: '上游 Zashboard 面板',
  upstreamBuiltin: '內建版本',
  upstreamActive: '使用中',
  upstreamActiveDesc: '正在使用上游版本 {version}',
  upstreamSwitchBuiltin: '切回內建版本',
  upstreamCheckVersions: '檢查上游版本',
