...
const ru: LANG_MESSAGE = {
  ...
  tunnelForwarding: 'Туннель переадресации портов',
  tunnelTool: 'Инструмент переадресации',
  tunnelArgs: 'Аргументы команды',
  tunnelLocalPort: 'Локальный порт',
  tunnelAutoStart: 'Автозапуск при старте',
  ...
  tunnelAvBlockedDesc:
    'Windows Defender ошибочно заблокировал туннельный инструмент. Нажмите ниже, чтобы добавить исключение (требуются права администратора).',
  tunnelAvFix: 'Добавить исключение Defender',
  tunnelAvFixed: 'Исключение добавлено для',
  tunnelHealthRestored: 'Туннели восстановлены',
  updaterTitle: 'Обновления приложения',
  updaterCurrentVersion: 'Текущая версия',
  updaterCheck: 'Проверить обновления',
  updaterAvailable: 'Доступно обновление',
  updaterUpToDate: 'У вас последняя версия',
  updaterOpenRelease: 'Открыть релиз',
  updaterShowHistory: 'Показать все версии',
  updaterHideHistory: 'Скрыть версии',
  updaterCurrent: 'текущая',
  updaterCustomUrl: 'Пользовательский URL обновлений',
  updaterCustomUrlPlaceholder: 'https://api.github.com/repos/user/repo/releases',
  updaterCustomUrlSaved: 'Пользовательский URL сохранён',
  updaterCustomUrlCleared: 'Восстановлен URL по умолчанию',
  updaterCheckFailed: 'Ошибка проверки обновлений',
  updaterDownloadFailed: 'Ошибка загрузки',
  upstreamTitle: 'Upstream Zashboard UI',
  upstreamBuiltin: 'Встроенная',
  upstreamActive: 'Активна',
  upstreamActiveDesc: 'Используется upstream версия {version}',
  upstreamSwitchBuiltin: 'Вернуть встроенную',
  upstreamCheckVersions: 'Проверить upstream версии',
  upstreamDownloaded: 'Загружено',
  upstreamDownload: 'Загрузить',
  upstreamActivate: 'Использовать',
  upstreamLocalOnly: 'Локальные версии',
  upstreamOpen: 'Открыть',
  upstreamCustomUrl: 'Пользовательский URL',
  upstreamReleasesUrl: 'URL API релизов',
  upstreamDownloadBase: 'Базовый URL загрузки',
  upstreamClearCustom: 'Сбросить',
}
