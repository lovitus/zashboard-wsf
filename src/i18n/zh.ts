...
const zh: LANG_MESSAGE = {
  ...
  tunnelForwarding: '端口转发隧道',
  tunnelTool: '转发工具',
  tunnelArgs: '命令参数',
  tunnelLocalPort: '本地端口',
  tunnelAutoStart: '启动时自动连接',
  tunnelStart: '启动隧道',
  tunnelStop: '停止隧道',
  tunnelRunning: '运行中',
  tunnelStopped: '已停止',
  ...
  tunnelAvBlockedDesc:
    'Windows Defender 误报了隧道工具。点击下方添加排除项（需要管理员权限，会弹出 UAC 提示）。',
  tunnelAvFix: '添加 Defender 排除项',
  tunnelAvFixed: '已添加排除项',
  tunnelHealthRestored: '隧道已恢复',
  updaterTitle: '应用更新',
  updaterCurrentVersion: '当前版本',
  updaterCheck: '检查更新',
  updaterAvailable: '有新版本可用',
  updaterUpToDate: '已是最新版本',
  updaterOpenRelease: '打开发布页',
  updaterShowHistory: '显示所有版本',
  updaterHideHistory: '隐藏版本列表',
  updaterCurrent: '当前',
  updaterCustomUrl: '自定义更新地址',
  updaterCustomUrlPlaceholder: 'https://api.github.com/repos/user/repo/releases',
  updaterCustomUrlSaved: '自定义地址已保存',
  updaterCustomUrlCleared: '已恢复默认更新地址',
  updaterCheckFailed: '检查更新失败',
  updaterDownloadFailed: '下载失败',
  upstreamTitle: '上游 Zashboard 面板',
  upstreamBuiltin: '内置版本',
  upstreamActive: '使用中',
  upstreamActiveDesc: '正在使用上游版本 {version}',
  upstreamSwitchBuiltin: '切回内置版本',
  upstreamCheckVersions: '检查上游版本',
