...
fn inject_scripts(html_bytes: &[u8], storage_b64: Option<&str>, safe_area_insets: Option<&str>) -> Vec<u8> {
    ...
    // Universal Sticky Fix: Offset any element with sticky/fixed positioning.
    head_scripts.push_str("<style>:root{--wsf-sai-top:0px;--wsf-sai-bottom:0px;--wsf-sai-left:0px;--wsf-sai-right:0px;}.wsf-safe-mode{--safe-area-inset-top:var(--wsf-sai-top);--safe-area-inset-bottom:var(--wsf-sai-bottom);--safe-area-inset-left:var(--wsf-sai-left);--safe-area-inset-right:var(--wsf-sai-right);--wsf-h-dvh:calc(100dvh - var(--wsf-sai-top) - var(--wsf-sai-bottom));--wsf-h-vh:calc(100vh - var(--wsf-sai-top) - var(--wsf-sai-bottom));padding-top:var(--wsf-sai-top) !important;padding-bottom:var(--wsf-sai-bottom) !important;box-sizing:border-box !important;height:100% !important;min-height:0px !important;overflow:hidden !important;border-top:var(--wsf-sai-top) solid transparent !important;}.wsf-safe-mode body{height:100% !important;overflow:auto !important;box-sizing:border-box !important;}.wsf-safe-mode #app-content, .wsf-safe-mode .h-dvh, .wsf-safe-mode .h-screen{height:var(--wsf-h-dvh, 100dvh) !important;max-height:100% !important;min-height:0px !important;}.wsf-safe-mode [class*='sticky'], .wsf-safe-mode [style*='sticky'], .wsf-safe-mode .tab, .wsf-safe-mode .navbar, .wsf-safe-mode [class*='navbar'] { top: var(--wsf-sai-top, 0px) !important; }</style>");
